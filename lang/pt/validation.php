...
return [
    ...
    */
    ...
    'unique_document'      => 'Este documento já está sendo utilizado.',
    'unique_email'         => 'Este email já está sendo utilizado.',
    'stock_available'      => 'O periodo selecionado é invalido.',
    'product_variation'    => 'Selecione ao menos uma opção.',
    ...
    */
    ...
    'custom' => [
        'period.started_at'  => [
            'required' => 'Selecione as datas do periodo',
        ],
        'period.finished_at' => [
            'required' => 'Selecione as datas do periodo',
        ],
        'cover' => [
            'required' => 'Por favor selecione uma capa para o álbum',
        ],
        'comment' => [
            'required_if' => 'Por favor informe os ajustes necessários no layout',
        ],
        'g-recaptcha-response' => [
            'required'  => 'Por favor confirme a validação de segurança',
            'recaptcha' => 'Por favor confirme a validação de segurança',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'country'              => 'País',
        'picture'              => 'Imagem',
        'cover'                => 'Capa do Produto',
        'slug'                 => 'URL amigável',
        'content'              => 'Conteúdo',
        'amount'               => 'Total',
        'code'                 => 'Código',
        'service_number'       => 'Nrº do Serviço',
        'created_at'           => 'Criado em',
        'started_at'           => 'Iniciado em',
        'issued_at'            => 'Emitido em',
        'dued_at'              => 'Vencimento em',
        'published_at'         => 'Primeira Publicação',
        'started_at'           => 'Periodo Inicial',
        'finished_at'          => 'Periodo Final',
